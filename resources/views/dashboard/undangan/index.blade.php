    ...
    <div>
      ...
      <div class="row justify-content-center align-items-start g-2">
        ...
        <div class=" col-lg-7 column">
          ...
          <div class="row py-lg-2">
            <div class=" py-3 py-lg-0">
              <label class="label-form" for="a">Foto Gallery</label>
        ...
        <div class="col-lg-7 column">
          <div class="row  py-lg-2">
            <div class=" py-3 py-lg-0">
              ...
              <input class="form-control col-6 @error('songs') is-invalid @enderror" type="file" id="songs" name="songs" onchange="audioPreview">
              <select class="form-select form-select mb-3 mt-3" name="songopt" id="">
              ...
              <audio controls>
                @if(isset($songs[0]) && !empty($songs[0]->audio_path))
