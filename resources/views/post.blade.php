...
<div class="card mb-3">
  ...
  @else
  <img src="https://source.unsplash.com/1200x400/?married" class="card-img-top" alt="pernikahan">
  ...
  <div class="card-body text-center">
    ...
    <p>
      <small class="text-muted">
        By. <a href="/blogs?author={{ $posts[0]->author->username }}" class="text-decoration-none">{{ $posts[0]->author->name }}</a> {{ $posts[0]->created_at->diffForHumans() }}
      </small>
    </p>
